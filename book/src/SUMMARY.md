...
- [Browsing Flows](guide/browsing-flows.md)
- [Statistics](guide/statistics.md)
- [Sankey Diagram](guide/sankey.md)
- [Looking Up an IP](guide/ip-lookup.md)
- [Setting Up Alerts](guide/alerts.md)
- [Admin & Health](guide/admin-health.md)
- [Preferences](guide/preferences.md)

# Developer Reference
- [Overview](architecture/overview.md)
- [Reactive Loop: Signals, Actions & SSE](architecture/reactive-loop.md)
- [Data Sources: RRD vs. VictoriaMetrics](architecture/data-sources.md)
...
- [Environment Notes](development/environment-notes.md)
- [Traffic Graphs](features/graphs.md)
- [Flow Browser](features/flows.md)
- [Statistics](features/statistics.md)
- [Sankey Diagram](features/sankey.md)
