...
describe('Rrd::get_data_path()', function (): void {
...
describe('Rrd::validateStructure() without existing file', function (): void {
    ...
    test('non-existent source returns valid=false with null rows', function (): void {
...
describe('Rrd::healthChecks() filesystem checks', function (): void {
    ...
    test('non-existent rrdPath emits rrd_dir error entry', function (): void {
    ...
    test('healthChecks always includes import_years entry', function (): void {
